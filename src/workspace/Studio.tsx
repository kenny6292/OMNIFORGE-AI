...
import { ArrowLeft, Box, Layers3, Settings2, Maximize2, Play, Rotate3D, Save, FolderOpen, Bot } from "lucide-react";
...
export function Studio({onBack}:{onBack:()=>void}) {
 ...
 return <div className="studio-workspace">
  ...
  </div>{assistantOpen&&<AIAssistant projectId={projectId} sceneId={sceneId} onClose={()=>setAssistantOpen(false)}/>}
